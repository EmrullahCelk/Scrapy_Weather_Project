...
##################################################################################################################################################
    ...
    def Info(self):
        ...
        self.messagebox.information(self,"About This App","This app is made by ketadev. Shows current weather information for specific cities. Brings the last updated information when there is no internet connection.\n\nDevelopment Team:\nMustafa, Omer, Emrullah, Tayyip")
        self.messagebox.setWindowIcon(icon)

##################################################################################################################################################
    
    def keyPressEvent(self, e): # kalıp bir fonksiyon "Qt.Key_ ' in sonuna yazılan tuşa basıyor(enter için kullanılır)"
